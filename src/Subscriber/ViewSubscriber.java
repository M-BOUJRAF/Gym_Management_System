 ...
 * @author HP
 */
public class ViewSubscriber extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewSubscriber
     */
...
//        this.setIconImage(ic.getImage());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View  Subscriber");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSubscriber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSubscriber().setVisible(true);
            }
        });
    }
